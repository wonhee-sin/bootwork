	...
	<div align="center">
		...
		<table style="width:600; text-align:center; background:#faf5ef;" border="1">
			<tr height="30">
				...
				<td align="center" width="450"><input type="text" name ="title" size="50" value="${board.title}"></td>
			</tr>
			<tr height="30">
			...
			<tr>
				...
				<td align="center"><textarea rows="10" cols="50" name="content"><c:out value="${board.content}" /></textarea></td>
			</tr>
			<tr height="30">
